...
class ResNet(nn.Module):
    def __init__(
        ...
        self.inplanes = num_in_channels  # 3
        self.dilation = 1
...
class Pose2Action(nn.Module):
    """2D ResNet action recognition network with pose series as input"""
...
if __name__ == "__main__":
    model = Pose2Action(num_classes=1064)
